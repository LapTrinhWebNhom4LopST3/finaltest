				...
				<table class="table table-hover" name="dsgv">
					<thead>
						<tr>
							...
							<th>Trống Từ</th>
							<th>Tới</th>
							<th><a href="AD_NhapPhong.jsp"><button type="submit" class="btn btn-success custom-width">Thêm Phòng</button></a></th>
						</tr>
                    ...
                    <tr>
                        ...
                        <td><a href="updatePhong_AD.jsp?idphong=<c:out value="${row.idphong}"/>"><button type="submit" class="btn btn-success">Update</button></a>
