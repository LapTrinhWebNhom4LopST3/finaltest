				...
				<table class="table table-hover" name="dsgv">
					<thead>
						<tr>
							...
							<th>Chuyên ngành</th>
							<th><a href="TK_NhapGV.jsp"><button type="submit" class="btn btn-success custom-width">Thêm Giảng Viên</button></a></th>
						</tr>
                    ...
                    <tr>
                        ...
                        <td><a href="updateGV.jsp?maGV=<c:out value="${row.MaGV}"/>"><button type="submit" class="btn btn-success">Update</button></a>
