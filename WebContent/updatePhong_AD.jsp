...
<sql:setDataSource var="dbsource" driver="com.mysql.jdbc.Driver"
                           url="jdbc:mysql://node1246-nhom4ltw.kilatiron.com/do_an"
	...
	<tr align="center">
<th><a href="AD_XemPhong.jsp"><h1>Xem kết quả</h1></a></th>
								...
								if (request.getParameter("sm") != null) {
									...
									String e1=request.getParameter("idphong");
										...
										try {
											...
											Connection connection = DriverManager.getConnection("jdbc:mysql://node1246-nhom4ltw.kilatiron.com/do_an", "root", "vothithanhvi");
