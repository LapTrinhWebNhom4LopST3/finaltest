				...
				<table class="table table-hover" name="dsgv">
					<thead>
						<tr>
							...
							<th><a href="AD_NhapDeTai.jsp"><button type="submit" class="btn btn-success custom-width">Thêm Đề Tài</button></a></th>
						</tr>
                    ...
                    <tr>
                        ...
                        <td><a href="update1_AD.jsp?idDT=<c:out value="${row.idDT}"/>"><button type="submit" class="btn btn-success">Update</button></a>
